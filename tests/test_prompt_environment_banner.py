...
ARGS_FIXOS = dict(
    ...
    missao_ativa_info='[Missão ativa: abc — "objetivo"]',
    ...
    conversation_active={"title": "tema", "started_at": "2026-08-01T00:00:00+00:00"},
    conversation_summaries=[{"started_at": "2026-08-02T00:00:00+00:00", "summary": "resumo"}],
    chat_manager_section="[bloco do chat manager]",
